...
func (a *App) initializeApiRoutes() {
	...
	userRouter.HandleFunc("", a.getUsers).Methods("GET")
	userRouter.HandleFunc("", a.createUser).Methods("POST")
	userRouter.HandleFunc("/{id:[0-9]+}", a.getUser).Methods("GET")
	userRouter.HandleFunc("/{id:[0-9]+}", a.updateUser).Methods("PUT")
	userRouter.HandleFunc("/{id:[0-9]+}", a.deleteUser).Methods("DELETE")

	postsRouter := a.APIRouter.PathPrefix("/posts").Subrouter()
	postsRouter.HandleFunc("", a.getPosts).Methods("GET")
	postsRouter.HandleFunc("", a.createPost).Methods("POST")
	postsRouter.HandleFunc("/{id:[0-9]+}", a.getPost).Methods("GET")
	postsRouter.HandleFunc("/{id:[0-9]+}", a.updatePost).Methods("PUT")
	postsRouter.HandleFunc("/{id:[0-9]+}", a.deletePost).Methods("DELETE")

	managementRouter := a.APIRouter.PathPrefix("/manage").Subrouter()
	managementRouter.HandleFunc("/create", a.manageCreate).Methods("POST")
	managementRouter.HandleFunc("/migrate", a.manageMigrate).Methods("POST")
}
